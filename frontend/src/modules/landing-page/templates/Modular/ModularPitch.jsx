 ...
 * Diseño centrado con tipografía elegante y comillas decorativas.
 */
const ModularPitch = ({ content, theme = {} }) => {
  const { 
  ...
  return (
    <div className="py-32 px-8 bg-slate-50 flex flex-col items-center text-center font-sans overflow-hidden relative">
      ...
      <div className="max-w-4xl mx-auto space-y-16 relative z-10">
        ...
        <blockquote className="text-3xl md:text-5xl font-bold text-slate-900 leading-tight tracking-tight italic">
          "{text}"
        </blockquote>
        ...
        <div className="flex flex-col items-center gap-6 pt-4">
          ...
          <div className="space-y-1">
            <p className="text-xl font-black text-slate-900 tracking-tighter uppercase">{author}</p>
